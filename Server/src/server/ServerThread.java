...
public class ServerThread extends Thread {
	...
	// private int broadcast(byte[] data) {
	...
	private void processInstruction(byte op, int datalen, byte[] data) {
		...
		case OP_BROADCAST:
			...
			break;
		case OP_SENDGAME:
			log("User Uploaded: "+data[0]+" "+data[1]+","+data[2]+","+data[3]+","+data[4]+"");
			server.setGame(data);
			break;
		case OP_DOWNLOADGAME:
			sendMessage(packInstruction(OP_DOWNLOADGAME,server.getGame()));
			break;
		case OP_EXIT:
